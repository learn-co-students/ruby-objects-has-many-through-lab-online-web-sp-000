...
describe 'Patient' do
  ...
  describe '#new_appointment' do
    it 'given a doctor and date, creates a new appointment belonging to that patient' do
      ...
      appointment = hevydevy.new_appointment(doctor:doctor_who, date:'Friday, January 32nd')
  ...
  describe '#doctors' do
    it 'has many doctors through appointments' do
      ...
      hevydevy = Patient.new('Devin Townsend')
      hevydevy.new_appointment(doctor:doctor_who, date:'Friday, January 32nd')
      hevydevy.new_appointment(doctor:doctor_what, date:'Saturday, January 32nd')
